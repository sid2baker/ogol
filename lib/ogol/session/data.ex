  ...
  def reduce(%__MODULE__{} = state, operation) do
    case operation do
      ...
      {:put_loaded_revision, app_id, revision, inventory} ->
        ...
        {loaded_revision, %__MODULE__{state | loaded_revision: loaded_revision}}
      ...
      :reset_loaded_revision ->
        {:ok, %__MODULE__{state | loaded_revision: nil}}
    end
  end
